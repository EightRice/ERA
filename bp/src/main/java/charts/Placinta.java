...
@UIScope
@SpringView
public class Placinta extends AbstractChartView {
    ...
    public Placinta(ArrayList<Integer>valori) {
    	this.valori=valori;int	 total=0;
    ...
    public Component getChart() {
        ...
        config.
            options()
                ...
                .title()
                    .display(true)
                    .text("Voting preferences unweighted")
                    .and()
                .animation()
                    //.animateScale(true)
                    .animateRotate(true)
