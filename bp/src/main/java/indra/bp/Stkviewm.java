...
public class Stkviewm extends AbsoluteLayout{
	public double distance;
	public Stakeholder stakeholder;
	CheckBox chec;
	Clustering clust;
	public String name;
	public Stkviewm(SmallVotes stakeholder, Dreapta pedreapta,ArrayList<Stakeholder>selectati,CheckBox ck,boolean ecluster,double distance){
	setHeight("30px");
	setStyleName("unom");
	setWidth("100%");
	...
	account.addClickListener(new ClickListener() {
		...
		public void buttonClick(ClickEvent event) {
			getUI().getCurrent().addWindow(new Stakewinm(stakeholder));
		}
	});
